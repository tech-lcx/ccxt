...
module.exports = class bidesk extends Exchange {
    describe() {
        return this.deepExtend(super.describe(), {
            ...
            'urls': {
                'logo': 'https://www.bidesk.com/bidesk-85x25.jpg', // 交易所LOGO
                'api': {
                    'quote': 'https://api.bidesk.com/openapi/quote',
                    'contract': 'https://api.bidesk.com/openapi/contract',
                    'public': 'https://api.bidesk.com/openapi',
                    'private': 'https://api.bidesk.com/openapi',
                    'zendesk': 'https://bidesk.zendesk.com/hc/en-us',
                },
                'www': 'https://www.bidesk.com',
                'referral': 'https://www.bidesk.com/register/WqIHyc',
                'doc': 'https://github.com/bidesk/bidesk-api-docs',
                'fees': 'https://bidesk.zendesk.com/hc/en-us/articles/360035858954-Fee-Structure',
            },
            'api': {
                'public': {
                    'get': [
    ...
    async createOrder(symbol, type, side, amount, price = undefined, params = {}) {
        ...
        const request = {
            'symbol': market['id'],
            // BUY or SELL for spot
            'side': orderSide,
            // GTC, FOK, IOC for spot
    ...
    async fetchAccounts(params = {}) {
        ...
        //             "accountType": 1, // 1 token trading, 3 futures
    ...
    async fetchLedger(code = undefined, since = undefined, limit = undefined, params = {}) {
        await this.loadMarkets();
        const request = {
            'accountType': 1, // spot 1, futures 3
